...
const PLANS = [
    {
        ...
        pitch: "Try HostFlows risk-free with your first property.",
        features: [
            ...
            { label: "iCal sync (Airbnb / VRBO)", ok: false },
            { label: "Automated guest messaging", ok: false },
            { label: "Guest upsell engine", ok: false },
    ...
    },
    {
        ...
        name: "Growth",
        price: 29,
        pitch: "For active hosts who want automation and no limits on stays.",
        badge: "Most popular",
        highlight: true,
        features: [
    ...
    },
    {
        ...
        name: "Pro",
        price: 79,
        pitch: "For serious hosts and property managers scaling their portfolio.",
        features: [
